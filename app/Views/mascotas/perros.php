<div class="container">
    <div class="row">
        ...
        <form action="<?= base_url('index.php/usuario/perros/'); ?>" method="GET">
            <lable for="idRaza" class="form-label">Raza:</lable>
                <select name="idRaza" class="form-control">
                    <option value="%%" select>Cualquier tipo de mascota</option>
                    <?php foreach($razas as $raza): if($raza->tipo == "Perro"):?>
